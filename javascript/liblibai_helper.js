...
function adjust_iframe() {
    var ifm = document.getElementById("liblibai-iframe");
...
const get_new_helper_py_msg = (max_count=3) => new Promise((resolve, reject) => {
    console.log("run get_new_helper_py_msg")
...
async function open_model_url(event, model_type, search_term){
    ...
    let new_py_msg = await get_new_helper_py_msg();
